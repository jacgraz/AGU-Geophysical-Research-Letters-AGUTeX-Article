...
%DIF ADD Grazioli_JGRA_2024_R1.tex   Wed Dec 11 17:45:38 2024
...
}\DIFdelend \DIFaddbegin \DIFadd{ground-based polarimetric radar data as well as for exploiting satellite-based observations and their (all-sky) assimilation, as done for example by the European Centre for Medium-Range Weather Forecasts ECMWF~\mbox{%DIFAUXCMD
...
Atmospheric conditions are expected to play a role in shaping orientation distributions\DIFdelbegin \DIFdel{, particularly increasing wind conditions.
}\DIFdelend \DIFaddbegin \DIFadd{: atmospheric turbulence is probably a key driver, as well as horizontal winds interacting with the instrument frame~\mbox{%DIFAUXCMD
